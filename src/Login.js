    ...
    return (
        <div className="login-container">
            ...
            <form onSubmit={handleForm}>
                ...
                <input className="login-input" type='text' value={username} onChange={handleUsername} placeholder="Enter Username"></input><br></br>
                <span className="login-text">Password</span>
                <input className="login-input" type='password' value={password} onChange={handlePassword} placeholder="Enter Password"></input><br></br>
